      ...
      <div className="flex w-full flex-col items-center gap-2">
        <div className="flex w-full justify-center">
          <button
            ...
            className="relative flex size-[224px] shrink-0 flex-col items-center justify-center gap-2 rounded-full border-4 border-dashed border-[#201C44] bg-white px-4 text-center transition hover:bg-slate-50"
          >
            {profileFile && profileSrc ? (
              <>
                ...
                <img
                  src={profileSrc}
                  alt=""
                  className="absolute inset-1 size-[216px] rounded-full object-cover"
                />
              </>
            ) : (
              <>
