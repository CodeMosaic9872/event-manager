...
export function SupplierPlanVerifiedFeatureRow({ children }: { children: ReactNode }) {
  return (
    <div className="flex flex-row items-center gap-3">
      <span className="min-w-0 flex-1 text-left text-[14px] leading-5 text-black">
        {children}
      </span>
      <Image
        src="/verified.svg"
...
export function SupplierPricingPlanCard({
  ...
  return (
    <div className={`${shell} dir-ltr`} lang="en">
      ...
      <h3
        className="text-left text-[20px] font-normal leading-7 text-black"
        style={{ fontFamily: marketingPloniFont }}
      >
        {title}
      </h3>
      ...
      <div className="mt-6 flex flex-col gap-4">
        <div className="flex flex-row items-end justify-between gap-2">
          <span className="text-[16px] leading-5 text-black">
            {periodCaption}
          </span>
          <span
