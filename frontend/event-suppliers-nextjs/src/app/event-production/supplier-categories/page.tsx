...
export default function SupplierCategoriesPage() {
  return (
    <section className="relative mx-auto min-h-[calc(100vh-120px)] w-full max-w-[1440px] overflow-hidden rounded-[24px] border border-[#bfdbfe] bg-[linear-gradient(180deg,#9BD3EF_0%,#FFFFFF_58%)] px-6 py-10">
      <div className="pointer-events-none absolute -start-20 top-40 size-72 rounded-full bg-[#6ab7ff]/20 blur-2xl" />
      <div className="pointer-events-none absolute -end-24 bottom-4 size-72 rounded-full bg-[#6ab7ff]/30 blur-2xl" />
        ...
        {categories.map((item) => (
          <Link
            ...
            className={`rounded-[24px] border border-[#c3d3df] px-8 py-6 text-center text-[42px] leading-none text-[#252a4b] ${
              item === "משקאות" ? "border-[#2f71d8] bg-[#201c44] text-white shadow-[inset_0_0_0_2px_#60b5ff]" : "bg-[#eaf3fb]"
            }`}
          >
            {item}
          </Link>
